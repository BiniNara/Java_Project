...
public enum CategoryBtnCode {
    ...
    KOREAN(Constants.KOREAN, KOREAN_IMG, KOREAN_FOOD_IMG, 130, 150, 150, 80),
    JAPANESE(Constants.JAPANESE, JAPANESE_IMG, JAPANESE_FOOD_IMG, 130, 250, 150, 80),
    CHINESE(Constants.CHINESE, CHINESE_IMG, CHINESE_FOOD_IMG, 130, 350, 150, 80),
    WESTERN(Constants.WESTERN,  WESTERN_IMG, WESTERN_FOOD_IMG, 130, 450, 150, 80),
    ASIAN(Constants.ASIAN, ASIAN_IMG, ASIAN_FOOD_IMG, 130, 550, 150, 80);
	DESSERT(Constants.DESSERT, DESSERT_IMG, DESSERT_FOOD_IMG, 130, 650, 150, 80);
